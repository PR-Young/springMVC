...
<script src="${ctx}/assets/sidebar-menu/sidebar-menu.js"></script>
<script src="${ctx}/assets/sidebar-menu/bootstrap-tab.js"></script>
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <i
						class="icon-leaf"></i> This is my DemoProject.
				</small>
				</a>
				<!-- /.brand -->
			</div>
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li class="divider"></li>
							<li><a href="${ctx}/sys/loginout"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
